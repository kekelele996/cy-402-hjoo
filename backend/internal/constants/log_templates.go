...
const (
	...
	LogTimeEntryCreateSuccess  = "time entry create success"
	LogTimeEntryCreateFailed   = "time entry create failed"
	LogTimeEntryUpdateSuccess  = "time entry update success"
	LogTimeEntryDeleteSuccess  = "time entry delete success"
	LogInvoiceGenerateStart    = "invoice generate start"
	LogInvoiceGenerateSuccess  = "invoice generate success"
	LogInvoiceGenerateFailed   = "invoice generate failed"
	LogInvoiceReleaseEntries   = "invoice void release time entries"
	LogHourlyRateUpdate        = "user hourly rate update"
