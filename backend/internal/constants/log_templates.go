...
const (
	...
	LogBillingGenerateSuccess  = "billing generate from time entries success"
	LogBillingGenerateFailed   = "billing generate from time entries failed"
	...
	LogTimeEntryDeleteFailed   = "time entry delete failed"
