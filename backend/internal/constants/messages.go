...
const (
	...
	MsgTimeEntryCreated       = "工时登记成功"
	MsgTimeEntryUpdated       = "工时已更新"
	MsgTimeEntryDeleted       = "工时已删除"
	MsgInvoiceGenerated       = "收费单生成成功"
	MsgNoUnbilledTimeEntries  = "该案件没有可结算的未收费工时"
	MsgTimeEntryAlreadyBilled = "工时已进入收费单，不能重复结算"
	MsgHourlyRateUpdated      = "费率已更新"
)
