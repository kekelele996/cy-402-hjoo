...
func appErrorStatus(code int) int {
	...
	case constants.CodeConflict, constants.CodeCaseStatusConflict, constants.CodeBillingStatusConflict, constants.CodeTimeEntryAlreadyBilled:
		return http.StatusConflict
	case constants.CodeValidationFailed, constants.CodeNoUnbilledTimeEntries:
